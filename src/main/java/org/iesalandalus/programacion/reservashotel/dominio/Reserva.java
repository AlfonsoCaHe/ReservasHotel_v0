...
public class Reserva {
    ...
    public Reserva(Huesped huesped, Habitacion habitacion, Regimen regimen, LocalDate fechaInicioReserva, LocalDate fechaFinReserva, int numero_Personas){
        setHuesped(huesped);
        setHabitacion(habitacion);
        setRegimen(regimen);
        setFechaInicioReserva(fechaInicioReserva);
        setFechaFinReserva(fechaFinReserva);
        setNumeroPersonas(numero_Personas);
        this.checkIn = null;
        this.checkOut = null;
        setPrecio();
    }
    ...
    La fecha de inicio de la reserva no puede ser anterior al día que se intenta hacer la reserva.
    La fecha de inicio de la reserva no puede ser posterior al número de meses indicado por la constante MAX_NUMERO_MESES_RESERVA.
    ...
    El checkout debe hacerse como máximo a las 12:00 horas del día en que finaliza la reserva. Para esto deberás usar la constante MAX_HORAS_POSTERIOR_CHECKOUT.
    El atributo precio debe calcularse teniendo en cuenta el coste de la habitación, el régimen de alojamiento y el número de personas alojadas.
    */
    ...
    */
    ...
    public void setFechaFinReserva(LocalDate fechaFinReserva){
        try{
            ...
            if(fechaInicioReserva.isBefore(fechaFinReserva)) {
    ...
    /*  El checkout no puede ser anterior al checkin.
        El checkout debe hacerse como máximo a las 12:00 horas del día en que finaliza la reserva. Para esto deberás usar la
    ...
    */
    ...
    /*  El atributo precio debe calcularse teniendo en cuenta el coste de la habitación, el régimen de alojamiento y el número de
        personas alojadas.
    * */
    private void setPrecio() {
        Double costePorPersona = getHabitacion().getPrecio() + getRegimen().getIncrementoPrecio();//Calculamos el coste por persona de la habitación teniendo en cuenta el régimen y el tipo de habitación
        Double costeReservaPorDia = getNumeroPersonas() * costePorPersona;//Calculamos el coste total de la reserva por día
